...
contract collectable is ERC721Full {
  ...
  function mint(string memory _token) public {
    require(!_Exists[_token]);
    uint _id = collections.push(_token);
...
contract contractsHolder  {
 mapping(address => collectable) public adresses;
    constructor () public{}
     function mintCollectable (string  memory name, string memory symbol) public {
         collectable c = new collectable(name, symbol);
         adresses[msg.sender]=  c;
    }
